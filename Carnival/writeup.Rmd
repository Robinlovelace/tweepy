...
![The carnival boundary based on online maps]("data/carnival/carnival-bounds.png")

## Analysis

The filtered tweets are stored in 'output.csv' and can be loaded with the following command,
which tells us that a total of 2,268 tweets were recorded in total:
...
```{r Map of geolocated messages, echo=FALSE, warning=FALSE}
...
```{r Number of words per tweet, echo=FALSE}
library(tm)
library(stringr)
